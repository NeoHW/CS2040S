...
public class basicprogramming2 {
    ...
    public static void printInRange(int[] arr, int N) {
        int l = searchLowerBound(arr, 100);
        int h = searchUpperBound(arr, 999);
    ...
    // Lower bound: find lowest i, such that a[i] >= v
    public static int searchLowerBound(int[] arr, int v) {
    ...
    // Upper bound: find largest i, such that a[i] ,= v
    public static int searchUpperBound(int[] arr, int v) {
